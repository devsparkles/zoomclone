...
local_id_address = socket.gethostbyname(socket.gethostname())

server = StreamingServer(local_id_address, 9999)
receiver = AudioReceiver(local_id_address, 8888)
...
# GUI
window = tk.Tk()
window.title("zoom clone 0.0.1 alpha")
